...
item_table = {
    ...
    "Sentry": ItemData(9 + SC2WOL_ITEM_ID_OFFSET + SC2WOL_PROTOSS_OFFSET, "Protoss", 9, classification=ItemClassification.progression),
    "Adept": ItemData(10 + SC2WOL_ITEM_ID_OFFSET + SC2WOL_PROTOSS_OFFSET, "Protoss", 10, classification=ItemClassification.progression),
    "Oracle": ItemData(11 + SC2WOL_ITEM_ID_OFFSET + SC2WOL_PROTOSS_OFFSET, "Protoss", 11, classification=ItemClassification.progression),
    "Tempest": ItemData(12 + SC2WOL_ITEM_ID_OFFSET + SC2WOL_PROTOSS_OFFSET, "Protoss", 12, classification=ItemClassification.progression),
    "Observer": ItemData(13 + SC2WOL_ITEM_ID_OFFSET + SC2WOL_PROTOSS_OFFSET, "Protoss", 13, classification=ItemClassification.progression),
    "Warp Prism": ItemData(14 + SC2WOL_ITEM_ID_OFFSET + SC2WOL_PROTOSS_OFFSET, "Protoss", 14, classification=ItemClassification.progression),
    "Disruptor": ItemData(15 + SC2WOL_ITEM_ID_OFFSET + SC2WOL_PROTOSS_OFFSET, "Protoss", 15, classification=ItemClassification.progression),
    "Archon": ItemData(16 + SC2WOL_ITEM_ID_OFFSET + SC2WOL_PROTOSS_OFFSET, "Protoss", 16, classification=ItemClassification.progression, parent_item="High Templar"),

    "Zergling":  ItemData(0 + SC2WOL_ITEM_ID_OFFSET + SC2WOL_ZERG_OFFSET, "Zerg", 0, classification=ItemClassification.progression),
    "Baneling": ItemData(1 + SC2WOL_ITEM_ID_OFFSET + SC2WOL_ZERG_OFFSET, "Zerg", 1, classification=ItemClassification.progression, parent_item="Zergling"),
    ...
    "Ravager": ItemData(4 + SC2WOL_ITEM_ID_OFFSET + SC2WOL_ZERG_OFFSET, "Zerg", 4, classification=ItemClassification.progression, parent_item="Roach"),
    "Hydralisk": ItemData(5 + SC2WOL_ITEM_ID_OFFSET + SC2WOL_ZERG_OFFSET, "Zerg", 5, classification=ItemClassification.progression),
    "Lurker": ItemData(6 + SC2WOL_ITEM_ID_OFFSET + SC2WOL_ZERG_OFFSET, "Zerg", 6, classification=ItemClassification.progression, parent_item="Hydralisk"),
    ...
    "Brood Lord": ItemData(9 + SC2WOL_ITEM_ID_OFFSET + SC2WOL_ZERG_OFFSET, "Zerg", 9, classification=ItemClassification.progression, parent_item="Corruptor"),
    ...
    "Viper": ItemData(15 + SC2WOL_ITEM_ID_OFFSET + SC2WOL_ZERG_OFFSET, "Zerg", 15, classification=ItemClassification.progression),
    "Swarm Host": ItemData(16 + SC2WOL_ITEM_ID_OFFSET + SC2WOL_ZERG_OFFSET, "Zerg", 16, classification=ItemClassification.progression),
